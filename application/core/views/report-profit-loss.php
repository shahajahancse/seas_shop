          ...
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
                ...
                <tr>
                  ...
                  <td class="text-right text-bold"><?php echo $CI->currency(number_format($opening_stock_price,2,'.','')); ?></td>
                </tr>  
                ...
                <tr>
                  ...
                  <td class="text-right text-bold"><?php echo $CI->currency(number_format($pur_total,2,'.','')); ?></td>
                </tr>   
                <!-- Total Purchase Tax -->
                <tr>
                  <td><?= $this->lang->line('total_purchase_tax'); ?></td>
                  <td class="text-right text-bold"><?php echo $CI->currency(number_format(($purchase_tax_amt),2,'.','')); ?></td>
                </tr>  
                <!-- Total Purchase Other Charges -->
                <tr>
                  <td><?= $this->lang->line('total_other_charges_of_purchase'); ?></td>
                  <td class="text-right text-bold"><?php echo $CI->currency(number_format($pur_other_charges_amt,2,'.','')); ?></td>
                </tr>

                <!-- Total Purchase Doscount -->
                <tr>
                  <td><?= $this->lang->line('total_discount_on_purchase'); ?></td>
                  <td class="text-right text-bold"><?php echo $CI->currency(number_format($purchase_discount_amt,2,'.','')); ?></td>
                </tr>

                <!-- Total Purchase Paid Amount -->
                <tr>
                  <td><?= $this->lang->line('paid_amount'); ?></td>
                  <td class="text-right text-bold text-success"><?php echo $CI->currency(number_format($purchase_paid_amount,2,'.','')); ?></td>
                </tr> 

                <!-- Total Purchase Due -->
                <tr>
                  <td><?= $this->lang->line('purchase_due'); ?></td>
                  <td class="text-right text-bold text-danger"><?php echo $CI->currency(number_format($purchase_due_total,2,'.','')); ?></td>
                </tr> 
                ...
                <tr>
                  ...
                  <td class="text-right text-bold"><?php echo $CI->currency(number_format($pur_return_total,2,'.','')); ?></td>
                </tr>   
                <!-- Total Purchase return Tax -->
                <tr>
                  <td><?= $this->lang->line('total_purchase_return_tax'); ?></td>
                  <td class="text-right text-bold"><?php echo $CI->currency(number_format(($purchase_return_tax_amt),2,'.','')); ?></td>
                </tr> 

                <!-- Total Purchase return Other Charges -->
                <tr>
                  <td><?= $this->lang->line('total_other_charges_of_purchase_return'); ?></td>
                  <td class="text-right text-bold"><?php echo $CI->currency(number_format($pur_return_other_charges_amt,2,'.','')); ?></td>
                </tr>
                <!-- Total Purchase return Doscount -->
                <tr>
                  <td><?= $this->lang->line('total_discount_on_purchase_return'); ?></td>
                  <td class="text-right text-bold"><?php echo $CI->currency(number_format($purchase_return_discount_amt,2,'.','')); ?></td>
                </tr>

                <!-- Total Purchase Return Paid Amount -->
                <tr>
                  <td><?= $this->lang->line('paid_amount'); ?></td>
                  <td class="text-right text-bold text-success"><?php echo $CI->currency(number_format($purchase_return_paid_amount,2,'.','')); ?></td>
                </tr> 

                <!-- Total Purchase returns Due -->
                <tr>
                  <td><?= $this->lang->line('purchase_return_due'); ?></td>
                  <td class="text-right text-bold text-danger"><?php echo $CI->currency(number_format($purchase_return_due_total,2,'.','')); ?></td>
                </tr> 
          ...
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
                ...
                <tr>
                  ...
                  <td class="text-right text-bold"><?php echo $CI->currency(number_format($exp_total,2,'.','')); ?></td>
                </tr>
                ...
                <tr>
                  ...
                  <td class="text-right text-bold"><?php echo $CI->currency(number_format($sal_total,2,'.','')); ?></td>
                </tr>   
                <!-- Total Sales Tax -->
                <tr>
                  <td><?= $this->lang->line('total_sales_tax'); ?></td>
                  <td class="text-right text-bold"><?php echo $CI->currency(number_format(($sales_tax_amt),2,'.','')); ?></td>
                </tr>   

                <!-- Total Sales Other Charges -->
                <tr>
                  <td><?= $this->lang->line('total_other_charges_of_sales'); ?></td>
                  <td class="text-right text-bold"><?php echo $CI->currency(number_format($sal_other_charges_amt,2,'.','')); ?></td>
                </tr>

                <!-- Total Sales Doscount -->
                <tr>
                  <td><?= $this->lang->line('total_discount_on_sales'); ?></td>
                  <td class="text-right text-bold"><?php echo $CI->currency(number_format($sales_discount_amt,2,'.','')); ?></td>
                </tr>
                <!-- Total Sales Paid Amount -->
                <tr>
                  <td><?= $this->lang->line('paid_amount'); ?></td>
                  <td class="text-right text-bold text-success"><?php echo $CI->currency(number_format($sales_paid_amount,2,'.','')); ?></td>
                </tr> 
                <!-- Total Sales Due -->
                <tr>
                  <td><?= $this->lang->line('sales_due'); ?></td>
                  <td class="text-right text-bold text-danger"><?php echo $CI->currency(number_format($sales_due_total,2,'.','')); ?></td>
                </tr> 
                ...
                <tr>
                  ...
                  <td class="text-right text-bold"><?php echo $CI->currency(number_format($sal_return_total,2,'.','')); ?></td>
                </tr>   
                <!-- Total sales return Tax -->
                <tr>
                  <td><?= $this->lang->line('total_sales_return_tax'); ?></td>
                  <td class="text-right text-bold"><?php echo $CI->currency(number_format(($sales_return_tax_amt),2,'.','')); ?></td>
                </tr> 
                <!-- Total Sales return Other Charges -->
                <tr>
                  <td><?= $this->lang->line('total_other_charges_of_sales_return'); ?></td>
                  <td class="text-right text-bold"><?php echo $CI->currency(number_format($sal_return_other_charges_amt,2,'.','')); ?></td>
                </tr>
                <!-- Total Sales return Doscount -->
                <tr>
                  <td><?= $this->lang->line('total_discount_on_sales_return'); ?></td>
                  <td class="text-right text-bold"><?php echo $CI->currency(number_format($sales_return_discount_amt,2,'.','')); ?></td>
                </tr>
                <!-- Total Sales return Paid Amount -->
                <tr>
                  <td><?= $this->lang->line('paid_amount'); ?></td>
                  <td class="text-right text-bold text-success"><?php echo $CI->currency(number_format($sales_return_paid_amount,2,'.','')); ?></td>
                </tr> 
                <!-- Total Sales Return Due -->
                <tr>
                  <td><?= $this->lang->line('sales_return_due'); ?></td>
                  <td class="text-right text-bold text-danger"><?php echo $CI->currency(number_format($sales_return_due_total,2,'.','')); ?></td>
                </tr> 
          ...
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
                ...
                <tr>
                  ...
                  <td class="text-right text-bold"><?php echo $CI->currency(number_format($gross_profit,2,'.','')); ?></td>
                </tr> 
                <!-- Total Net Profit -->
                <tr>
                  <td><?= $this->lang->line('net_profit'); ?></td>
                  <td class="text-right text-bold"><?php echo $CI->currency(number_format($tot_net_profit,2,'.','')); ?></td>
                </tr>   
                </table>
            </div>
            <!-- /.box-body -->
