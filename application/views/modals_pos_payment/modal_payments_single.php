<div class="modal fade" id="single-payments-modal">
          ...
          <div class="col-md-8">
            <div>
                ...
                if(isset($sales_id) && $sales_id!='') { //For Save Operation or for new entry
                  ...
                  if($q22->num_rows()>0){
                    ...
                    foreach ($q22->result() as $res22) { $i++; ?>
                      <input type="hidden" name="payment_row_count" id='payment_row_counts' value="<?= $i;?>">
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-6">
                                <div class="">
                                  ...
                                  <input type="text" class="form-control text-right payment only_currency" value='<?= $res22->payment;?>' id="samount_<?= $i;?>" name="amount_<?= $i;?>" placeholder="" onkeyup="calculate_payments_single()">
                                    <span id="samount_<?= $i;?>_msg" style="display:none" class="text-danger"></span>
                                </div>
                            </div>
                              <div class="col-md-6">
                                <div class="">
              ...
              <?php if($atleast_one_payments=='true'){ ?>
                <input type="hidden" name="payment_row_count" id='payment_row_counts' value="1">
                <div class="col-md-12  payments_div">
                  <div class="box box-solid bg-gray">
                    <div class="box-body">
                      <div class="row">
                        <div class="col-md-12">
                          <div class="">
                            ...
                            <input type="text" class="form-control text-right payment" id="samount_1" name="amount_1" placeholder="" onkeyup="calculate_payments_single()">
                              <span id="samount_1_msg" style="display:none" class="text-danger"></span>
                          </div>
                        </div>
                        <div class="clearfix"></div>
                      </div>
