...
class Suppliers extends MY_Controller {
	...
	public function ajax_list()
	{
		...
		foreach ($list as $suppliers) {
			...
			$row[] = $suppliers->email;
			$row[] = (!empty($suppliers->purchase_due) && $suppliers->purchase_due!=0) ? $this->currency($suppliers->purchase_due) : $this->currency(0);
			
			$row[] = ($suppliers->purchase_return_due==null) ? $this->currency(0) : $this->currency($suppliers->purchase_return_due);
